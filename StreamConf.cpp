 ...
 namespace po = boost::program_options;
  ...
  void StreamConf::add_options() {
    desc.add_options()("help,h", "show help message")(
        ...
        "userid for source database")(
        "password", po::value<std::string>(),
        "password for source database")(
        "server", po::value<std::string>(),
        "connection string for source database(tnsname)")(
         "charset", po::value<std::string>(), "utf8|gbk" ) (
        //"kafka.brokers", po::value<std::string>(), "kafka servers(host:port,..) ,format as 192.168.0.11:9092,192.168.0.12:9092..")(
        "target", po::value<std::string>(), "target database info")(
        "tables", po::value<std::string>(), "tables to migrate")(
        "commitNum", po::value<int>(), "number rows of every commit")(
